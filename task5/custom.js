                ...
                if (node.nodeType === 1 && node.classList.contains('react-aria-GridListItem')) {
                    ...
                    const poll = setInterval(() => {
                        ...
                        if (title && title !== "Untitled") {
                            // Get lyrics from textarea directly (Fix 1)
...
// Main function to fill an English song
function custom_fill() {
    ...
    const lyrics = "Under the sky of dreams, I’ll fly away\nThrough clouds of hope and light of day\nYour voice will guide me on my way";
